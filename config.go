...
func Bootstrap() {
	...
	CREATE TABLE terminatedgim (id INTEGER NOT NULL PRIMARY KEY, email TEXT);
	CREATE TABLE terminatedmetabase (id INTEGER NOT NULL PRIMARY KEY, email TEXT);
	`
		tx.Exec(sqlStmt)
...
// TrackGIMTerminated insert the GIM terminated email
func TrackGIMTerminated(email string) (bool, error) {

	sqlStmt := "INSERT INTO terminatedgim(email) VALUES (?)"
...
// ListGIMTerminated retrieves all the GIM terminated users email
func ListGIMTerminated() (*[]string, error) {

	selectStmt := "SELECT * FROM terminatedgim"
...
// TrackMetabaseTerminated insert the Metabase terminated email
func TrackMetabaseTerminated(email string) (bool, error) {

	sqlStmt := "INSERT INTO terminatedmetabase(email) VALUES (?)"
...
// ListMetabaseTerminated retrieves all the Metabase terminated users email
func ListMetabaseTerminated() (*[]string, error) {

	selectStmt := "SELECT * FROM terminatedmetabase"
